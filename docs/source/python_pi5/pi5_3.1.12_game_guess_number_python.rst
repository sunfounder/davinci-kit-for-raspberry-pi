...
.. note::
    Vous pouvez **Modifier/Réinitialiser/Copier/Exécuter/Arrêter** le code ci-dessous. Mais avant cela, vous devez vous rendre dans le répertoire du code source tel que ``raphael-kit/python-pi5``. Après modification, vous pouvez l'exécuter directement pour voir l'effet.
