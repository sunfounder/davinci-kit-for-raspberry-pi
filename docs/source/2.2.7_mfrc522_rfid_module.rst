...
This function is used to write card data, and if the write is 
successful, there will return "1". addr is the address of the 
card and data is the information to be written to the card.
