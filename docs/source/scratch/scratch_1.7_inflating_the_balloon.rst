...
.. image:: media/1.7header.png

Required Components
-----------------------

.. image:: media/1.7component.png

Build the Circuit
---------------------

.. image:: media/2.1.2_scratch_fritzing.png
...
Click the **Sound** option at the top, then click **Upload Sound** to upload ``boom.mp4`` from the ``home/pi/davinci-kit-for-raspberry-pi/scratch/sound`` path to Scratch 3.
